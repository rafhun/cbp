...
if (!defined('RELATIVE_PATH')) define('RELATIVE_PATH', ASCMS_LIBRARY_PATH.'/html2fpdf/');
        ...
        case 'IMG':
            ...
            if(isset($attr['SRC']))
            {
                ...
                if ($this->tdbegin) 
                {
                    ...
                    if (!FWValidator::isUri($srcpath) && !fopen($srcpath, 'rb')) //Show 'image not found' icon instead
                    {
...
*/
  ...
  $ind = 0;
    ...
    $CSSextblock = str_replace('h2', '.h2', $CSSextblock);
