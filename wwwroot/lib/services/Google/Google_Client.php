...
require_once ASCMS_LIBRARY_PATH . '/services/Google/service/Google_Model.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/service/Google_Service.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/service/Google_ServiceResource.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/auth/Google_AssertionCredentials.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/auth/Google_Signer.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/auth/Google_P12Signer.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/service/Google_BatchRequest.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/external/URITemplateParser.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/auth/Google_Auth.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/cache/Google_Cache.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/io/Google_IO.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/service/Google_MediaFileUpload.php';
