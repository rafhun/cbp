...
require_once ASCMS_LIBRARY_PATH . '/services/Google/auth/Google_Verifier.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/auth/Google_LoginTicket.php';
require_once ASCMS_LIBRARY_PATH . '/services/Google/service/Google_Utils.php';
