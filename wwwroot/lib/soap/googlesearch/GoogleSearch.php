...
/*	IMPORTANT	*/
//change this to point to the nusoap.php file in your computer.
//else, add the location of nusoap.php on your PHP include path.

if (ini_get('Soap Client') == true) {
	require_once ASCMS_LIBRARY_PATH.'/soap/googlesearch/nusoap.php';
}
