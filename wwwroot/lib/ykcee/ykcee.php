...
$ColorArray = array(
	...
	// self defined colors
	"#3366cc"	=> array( 63, 102, 204),
	"#c8d7ee"	=> array(200, 215, 238),
	"#ffff77"	=> array(255, 255, 119),
	"#ff7777"	=> array(255, 119, 119)
	);			
...
class ykcee{
	...
	var $legend_position;
	var $legend_background_color = "white";
	var $x_label_height;
	var $y_label_width;
	var $title_axis_x;
	var $title_axis_y;
	...
	***************************************/
	...
	function SetLegendBackgroundColor($p_background_color) {
		if (! isset($this->img)) $this->ImageCreate();
		
		list($r, $g, $b) = ColorSet($p_background_color);
		$this->legend_background_color = ImageColorAllocate($this->img, $r, $g, $b);
		return true;
	}
	...
	***************************************/
	...
	function DrawBackground() {
		ImageFilledRectangle($this->img, 0, 0, $this->image_width, $this->image_height, $this->background_color);
		return true;
	}
	...
	***************************************/
	...
	function DrawLegend() {
		...
		if ($this->legend_position != 0) {
			...
			ImageFilledRectangle($this->img, $x1, $y1, $x2, $y2, $this->legend_background_color);
